    ...
    while (opt != -1) {
        ...
        case 0:
            ...
            else if (command == "set-perm")
            {
                ...
                m_window_3 = set_distance(optarg, command,message_store, error, error_messages);
            else if (command == "wind-5")
                m_window_5 = set_distance(optarg, command,message_store, error, error_messages);
...
void Commander::set_help_message()
{
    m_help_message =
           ...
           "                            Default: "+misc::to_string(m_ref_hard_threshold)+"\n"
