...
bool Commander::init(int argc, char* argv[], Reporter& reporter)
{
    ...
    const struct option longOpts[] = {
        ...
        {"disable-mmap", no_argument, &m_disable_mmap, 1},
                              ...
                              Reporter& reporter)
{
    ...
    while (opt != -1)
    {
        ...
        case 0:
            ...
            {
                error = true;
                error_messages.append("Error: There is currently a bug with "
                                      "Pearson clumping. This feature is "
...
void Commander::set_help_message()
{
    m_help_message =
        ...
        + "\n"
          ...
          "analysis \n"
          "                             after clumping is performed. For "
          "PRSet, Y \n"
          "                             indicate the SNPs falls within the "
          "gene set \n"
...
{
    bool error = false;
    if (!m_provided_seed) { message["seed"] = misc::to_string(m_seed); }
    if (m_thread <= 0)
    {
        error = true;
