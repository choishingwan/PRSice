...
void Commander::set_help_message()
{
    m_help_message =
           ...
           "    --interval      | -i    The step size of the threshold. Default: "+ misc::to_string(m_inter_threshold)+ "\n"
           "    --lower         | -l    The starting p-value threshold. Default: " + misc::to_string(m_lower_threshold)+ "\n"
