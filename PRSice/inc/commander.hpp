...
public:
    ...
    std::string ld_prefix() const
    {
        return m_ld_prefix;
    };
    std::string get_gtf() const
    {
        return m_gtf;
    };
    std::vector<std::string> get_base() const
    {
        return m_base;
    };
    std::vector<std::string> get_bed() const
    {
        return m_bed_list;
    };
    ...
    std::vector<std::string> get_pheno_col() const
    {
        return m_pheno_col;
    };
    std::string get_pheno() const
    {
        return m_pheno_file;
    };
    ...
    std::string get_base(size_t i) const
    {
        return m_base.at(i);
    };
    std::string get_msigdb() const
    {
        return m_msigdb;
    };
    ...
    std::string get_cov_file() const
    {
        return m_covariate_file;
    };
    size_t get_thread() const
    {
        return m_thread;
    };
    size_t get_clump_kb() const
    {
        return m_clump_kb;
    };
    double get_clump_p() const
    {
        return m_clump;
    };
    double get_clump_r2() const
    {
        return m_clump_r2;
    };
    ...
    double get_inter() const
    {
        return m_inter;
    };
    double get_proxy() const
    {
        return m_proxy;
    };
    double get_bar_upper() const
    {
        return *max_element(m_barlevel.begin(), m_barlevel.end());
    };
    double get_bar_lower() const
    {
    ...
    bool target_is_binary() const
    {
        return m_target_is_binary;
    };
    bool get_base_binary(size_t i) const
    {
        return m_use_beta.at(i);
    };
    bool no_regression() const
    {
        return m_no_regress;
    };
    bool fastscore() const
    {
        return m_fastscore;
    };
    bool full() const
