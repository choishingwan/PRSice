...
| -----------------|:----:|
| Linux 64-bit | [v2.2.8](https://github.com/choishingwan/PRSice/releases/download/2.2.8/PRSice_linux.zip) |
| OS X 64-bit | [v2.2.8](https://github.com/choishingwan/PRSice/releases/download/2.2.8/PRSice_mac.zip) |
| Windows 32-bit | [v2.2.8](https://github.com/choishingwan/PRSice/releases/download/2.2.8/PRSice_win32.zip) |
| Windows 64-bit | [v2.2.8](https://github.com/choishingwan/PRSice/releases/download/2.2.8/PRSice_win64.zip) |
