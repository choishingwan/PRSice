...
*NOTE: All required packages can be automatically downloaded by PRSice using the --dir <directory> option.*
...
For Quick start use, please refer to [[this page| Running PRSice]]
